...
if __name__ == "__main__":
    ...
    # キャッシュ に保存されているファイルのファイル名を取得、ここでは試しにファイル番号が一桁台のファイルのみを読み込んでいる。
    train_data_files = glob.glob(RAW_DATA_DIR+"/c4-ja.tfrecord-0000*-of-01024.json.gz")
    print(train_data_files)
    validation_data_files = glob.glob(RAW_DATA_DIR+"/c4-ja-validation.tfrecord-0000*-of-00008.json.gz")
